...
<div class="container">
	...
	for(Produto p : lista_produtos_s){
		 ...
		 preco_total += p.getPreco_produto();
	%>
                ...
                <tbody>
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#"></a><%=produto.getNome()%></h4>
                                <h5 class="media-heading"> Loja: <a href="#"></a></h5>
                        ...
                        <td class="col-sm-1 col-md-1 text-center"><strong>R$<%=produto.getPreco_produto() %></strong></td>
                        <td class="col-sm-1 col-md-1 text-center"><strong>R$<%=produto.getPreco_produto() %></strong></td>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><h5><strong><%=preco_total %></strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        <td>   </td>
                        <td><h5>Outros Valores</h5></td>
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td><h3>Total</h3></td>
                        <td class="text-right"><h3><strong>R$ <%=preco_total %></strong></h3></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        ...
                        <button type="button" class="btn btn-default">
                            <span class="glyphicon glyphicon-shopping-cart"></span> Continuar no Shopping
                        </button></td>
                        <td>
                       <a class="btn btn-success"  href="../login.jsp">  Finalizar Pedido <span class="glyphicon glyphicon-play"></span></a>
