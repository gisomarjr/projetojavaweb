...
<body>
	...
	<p>
	<h3><span class="glyphicon glyphicon-th-list"></span>Cadastrar Fornecedor</h3>
	</p>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="nome">Razão Social da Loja</label>  
  <div class="col-md-5">
  <input id="nome" name="nome" placeholder="Razão Social da Loja" class="form-control input-md" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="razao_social">Nome Fantasia</label>  
  <div class="col-md-5">
  <input id="nome_fantasia" name="nome_fantasia" type="text" placeholder="Nome Fantasia" class="form-control input-md" required="">
