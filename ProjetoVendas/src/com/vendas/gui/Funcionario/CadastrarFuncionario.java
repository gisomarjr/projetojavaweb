...
public class CadastrarFuncionario extends JFrame {
	...
	JLabel lblCarregando = new JLabel("Validando FuncionÃ¡rio... ", loading, JLabel.CENTER);
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					//desabilitando o botÃ¡o maximizar
					frame.setResizable(false);
					frame.setTitle("Cadastro de FuncionÃ¡rio");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 final JLabel label = new JLabel("Validando FuncionÃ¡rio... ", loading, JLabel.CENTER);
	...
	public CadastrarFuncionario() {
		...
		JLabel lblCadastroDeFuncionario = new JLabel("Cadastro de FuncionÃ¡rio");
